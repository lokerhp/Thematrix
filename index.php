...
<br><br><h1 class="text-3xl font-bold">
    ...
    <center>
        <div class="switcher">
            <div><a href="settings.php"><i class="fa-solid fa-gear"></i></a> <a href="info.php"><i class="fa-solid fa-circle-info"></i></a> <a href="logout.php"><i class="fa-solid fa-right-from-bracket"></i></a></div><br>
